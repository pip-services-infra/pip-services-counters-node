...
exports.PerfMonMongoDbSchema = function (collection) {
    collection = collection || 'logs';
    let PerfMonSchema = new mongoose_1.Schema({
        _id: { type: String },
        name: { type: String, required: true, index: true },
        source: { type: String, required: true, index: true },
        type: { type: pip_services_components_node_1.CounterType, required: true, index: true },
...
//# sourceMappingURL=PerfMonMongoDbSchema.js.map