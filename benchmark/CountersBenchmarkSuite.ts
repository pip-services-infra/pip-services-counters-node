...
import { AddMongoDbCountersBenchmark } from './AddMongoDbCountersBenchmark';

export class CountersBenchmarkSuite extends BenchmarkSuite {

    public constructor() {
        super("Counters", "Counters Counters benchmark");
        ...
        this.addBenchmark(new AddMongoDbCountersBenchmark());
    }
